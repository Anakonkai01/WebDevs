...
$errorMessage = $errorMessage ?? null; // Lỗi đăng nhập (sai pass, user không tồn tại...)
$flashMessage = $flashMessage ?? null; // Thông báo chung (đăng ký thành công, xác thực thành công, reset pass thành công...)
        ...
        <div class="card-body p-4 p-lg-5">
            ...
            <form action="?page=handle_login" method="POST" novalidate>
                 ...
                 <div class="mb-3">
                     ...
                     <div class="input-group input-group-lg"> <?php // Tăng kích thước input group ?>
                 ...
                 <div class="mb-3"> <?php // Giảm margin bottom một chút ?>
                     <label for="password" class="form-label visually-hidden">Mật khẩu</label>
                     <div class="input-group input-group-lg password-input-group"> <?php // Tăng kích thước input group ?>
                 ...
                 <?php // Remember Me (Tùy chọn) & Forgot Password ?>
...
<?php // Nhúng JS riêng cho trang đăng nhập (chứa hàm togglePasswordVisibility) ?>
