...
// Determine the correct redirect URL for login attempts
$loginRedirectUrl = urlencode($_SERVER['REQUEST_URI'] ?? '?page=product_detail&id='.$productId);
...
?>
    <style>
        ...
        .product-actions-box .btn-wishlist:disabled { opacity: 0.5; pointer-events: none;}
        ...
        <div class="col-lg-7">
            ...
            <div class="product-actions-box border rounded p-3 mb-4">
                ...
                <form action="?page=cart_add" method="POST" id="add-to-cart-form" class="d-flex align-items-center gap-3">
                    ...
                    <?php // Wishlist Button ?>
                    <button type="button" <?php // *** IMPORTANT: type="button" *** ?>
    ...
    <div class="product-extra-info mt-5">
        ...
        <div class="tab-content p-4" id="productTabContent">
            ...
            <div class="tab-pane fade" id="specs-content" role="tabpanel" aria-labelledby="specs-tab">
                ...
                <?php // ... (Specs table rendering remains the same) ... ?>
                <?php
            ...
            <div class="tab-pane fade reviews-section" id="reviews-content" role="tabpanel" aria-labelledby="reviews-tab">
                ...
                <?php // ... (Review listing remains the same) ... ?>
                ...
                <hr class="my-4">
                <?php // Add Review Form ?>
                <?php // ... (Review form remains the same) ... ?>
...
<?php // ... (Related products section remains the same) ... ?>
...
<?php // --- JavaScript Section --- ?>
    <script>
        // --- Wishlist Toggle Function (UPDATED) ---
        async function toggleWishlist(buttonElement, productId) {
            ...
            if (buttonElement.classList.contains('disabled')) {
                ...
                window.location.href = '?page=login&redirect=<?= $loginRedirectUrl ?>'; // Sử dụng biến đã tạo
                return;
            }
